...
namespace Gov.Jag.Embc.Interfaces
{
    public class BCeIDBusinessQuery
    {
        ...
        public async Task<BCeIDBusiness> ProcessBusinessQueryByUsername(string requesterUserGuid, string userId)
        {
            if (String.IsNullOrEmpty(url))
            {
                return null;
            ...
            var myparams = new AccountDetailRequest();
            myparams.onlineServiceId = svcid;
            myparams.requesterUserGuid = requesterUserGuid;
            myparams.requesterAccountTypeCode = BCeIDAccountTypeCode.Business;
            //myparams.userId = userId;
            myparams.userGuid = requesterUserGuid;
            myparams.accountTypeCode = BCeIDAccountTypeCode.Business;
