...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMrollupfield
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMprocesssession> RollupfieldProcessSessions { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "rollupfield_AsyncOperations")]
        [NotMapped] public IList<MicrosoftDynamicsCRMasyncoperation> RollupfieldAsyncOperations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "RollupField_SyncErrors")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> RollupFieldSyncErrors { get; set; }
