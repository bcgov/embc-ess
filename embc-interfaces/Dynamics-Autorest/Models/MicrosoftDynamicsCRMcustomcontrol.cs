...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcustomcontrol
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMcustomcontrolresource> CustomcontrolResourceId { get; set; }
