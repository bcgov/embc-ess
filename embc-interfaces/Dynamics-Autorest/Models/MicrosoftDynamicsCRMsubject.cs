...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMsubject
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMproduct> SubjectProducts { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "subject_incidents")]
        [NotMapped] public IList<MicrosoftDynamicsCRMincident> SubjectIncidents { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "subject_sales_literature")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsalesliterature> SubjectSalesLiterature { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Subject_ProcessSessions")]
        [NotMapped] public IList<MicrosoftDynamicsCRMprocesssession> SubjectProcessSessions { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMsubject> SubjectParentSubject { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMasyncoperation> SubjectAsyncOperations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Subject_SyncErrors")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> SubjectSyncErrors { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "subject_kb_articles")]
        [NotMapped] public IList<MicrosoftDynamicsCRMkbarticle> SubjectKbArticles { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "subject_knowledgearticles")]
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticle> SubjectKnowledgearticles { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMbulkdeletefailure> SubjectBulkDeleteFailures { get; set; }
