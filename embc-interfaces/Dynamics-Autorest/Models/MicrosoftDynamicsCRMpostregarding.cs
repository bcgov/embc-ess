...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMpostregarding
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMpost> PostPostRegardings { get; set; }
