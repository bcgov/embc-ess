...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcategory
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMcategory> CategoryParentCategory { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Category_SyncErrors")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> CategorySyncErrors { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticle> KnowledgearticleCategory { get; set; }
