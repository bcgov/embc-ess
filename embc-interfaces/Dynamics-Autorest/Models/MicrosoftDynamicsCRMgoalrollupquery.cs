...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMgoalrollupquery
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalrollupqueryActualint { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_actualmoney")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryActualmoney { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_actualdecimal")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryActualdecimal { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_customint")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryCustomint { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_custommoney")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryCustommoney { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_customdecimal")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryCustomdecimal { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_inprogressint")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryInprogressint { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_inprogressmoney")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryInprogressmoney { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goal_rollupquery_inprogressdecimal")]
        [NotMapped] public IList<MicrosoftDynamicsCRMgoal> GoalRollupqueryInprogressdecimal { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> GoalRollupQueryDuplicateBaseRecord { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMasyncoperation> GoalrollupqueryAsyncOperations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "GoalRollupQuery_DuplicateMatchingRecord")]
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> GoalRollupQueryDuplicateMatchingRecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "goalrollupquery_ProcessSessions")]
        [NotMapped] public IList<MicrosoftDynamicsCRMprocesssession> GoalrollupqueryProcessSessions { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "GoalRollupQuery_SyncErrors")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> GoalRollupQuerySyncErrors { get; set; }
