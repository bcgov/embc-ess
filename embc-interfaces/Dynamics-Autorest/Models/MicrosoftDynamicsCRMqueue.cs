...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMqueue
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMprocesssession> QueueProcessSessions { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Queue_BulkDeleteFailures")]
        [NotMapped] public IList<MicrosoftDynamicsCRMbulkdeletefailure> QueueBulkDeleteFailures { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMpostfollow> QueuePostFollows { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "mailbox_regarding_queue")]
        [NotMapped] public IList<MicrosoftDynamicsCRMmailbox> MailboxRegardingQueue { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "queue_team")]
        [NotMapped] public IList<MicrosoftDynamicsCRMteam> QueueTeam { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "queue_entries")]
        [NotMapped] public IList<MicrosoftDynamicsCRMqueueitem> QueueEntries { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "queue_activity_parties")]
        [NotMapped] public IList<MicrosoftDynamicsCRMactivityparty> QueueActivityParties { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Queue_AsyncOperations")]
        [NotMapped] public IList<MicrosoftDynamicsCRMasyncoperation> QueueAsyncOperations { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMemail> QueueEmailEmailSender { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMsystemuser> QueuemembershipAssociation { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> QueueSyncErrors { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "queue_system_user")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsystemuser> QueueSystemUser { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "queue_PostRegardings")]
        [NotMapped] public IList<MicrosoftDynamicsCRMpostregarding> QueuePostRegardings { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "queue_principalobjectattributeaccess")]
        [NotMapped] public IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> QueuePrincipalobjectattributeaccess { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> QueueDuplicateMatchingRecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Queue_DuplicateBaseRecord")]
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> QueueDuplicateBaseRecord { get; set; }
