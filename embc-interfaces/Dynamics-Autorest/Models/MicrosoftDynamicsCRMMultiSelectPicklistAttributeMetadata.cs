...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMMultiSelectPicklistAttributeMetadata
    {
        ...
        /// MicrosoftDynamicsCRMMultiSelectPicklistAttributeMetadata class.
        /// </summary>
        public MicrosoftDynamicsCRMMultiSelectPicklistAttributeMetadata(string formulaDefinition = default(string), int? sourceTypeMask = default(int?), string parentPicklistLogicalName = default(string), IList<string> childPicklistLogicalNames = default(IList<string>))
        {
