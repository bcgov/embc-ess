...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMsocialprofile
    {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMincident> SocialprofileCases { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "SocialProfile_DuplicateBaseRecord")]
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> SocialProfileDuplicateBaseRecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "SocialProfile_AsyncOperations")]
        [NotMapped] public IList<MicrosoftDynamicsCRMasyncoperation> SocialProfileAsyncOperations { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMconnection> SocialprofileConnections1 { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "socialprofile_connections2")]
        [NotMapped] public IList<MicrosoftDynamicsCRMconnection> SocialprofileConnections2 { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> SocialProfileSyncErrors { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "socialprofile_principalobjectattributeaccess")]
        [NotMapped] public IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> SocialprofilePrincipalobjectattributeaccess { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "Socialprofile_SocialActivities")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsocialactivity> SocialprofileSocialActivities { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMprocesssession> SocialProfileProcessSessions { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "SocialProfile_DuplicateMatchingRecord")]
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> SocialProfileDuplicateMatchingRecord { get; set; }
