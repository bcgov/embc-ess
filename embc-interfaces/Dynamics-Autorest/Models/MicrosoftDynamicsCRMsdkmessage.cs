...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMsdkmessage
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMsdkmessage(string _organizationidValue = default(string), bool? isprivate = default(bool?), string _modifiedbyValue = default(string), bool? workflowsdkstepenabled = default(bool?), bool? expand = default(bool?), int? availability = default(int?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), bool? template = default(bool?), bool? isvalidforexecuteasync = default(bool?), string categoryname = default(string), bool? autotransact = default(bool?), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), bool? isactive = default(bool?), string _createdbyValue = default(string), string name = default(string), string _modifiedonbehalfbyValue = default(string), int? customizationlevel = default(int?), string sdkmessageid = default(string), string sdkmessageidunique = default(string), string throttlesettings = default(string), string _createdonbehalfbyValue = default(string), long? versionnumber = default(long?), bool? isreadonly = default(bool?), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsdkmessageprocessingstep> sdkmessageidSdkmessageprocessingstep = default(IList<MicrosoftDynamicsCRMsdkmessageprocessingstep>), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), IList<MicrosoftDynamicsCRMsdkmessagefilter> sdkmessageidSdkmessagefilter = default(IList<MicrosoftDynamicsCRMsdkmessagefilter>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser))
        {
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMsdkmessageprocessingstep> SdkmessageidSdkmessageprocessingstep { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMsdkmessagefilter> SdkmessageidSdkmessagefilter { get; set; }
