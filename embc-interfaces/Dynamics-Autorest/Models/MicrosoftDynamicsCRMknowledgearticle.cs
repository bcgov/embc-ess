...
namespace Gov.Jag.Embc.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMknowledgearticle
    {
        ...
        [NotMapped] public object RatingSum { get; set; }
        ...
        [NotMapped] public object Rating { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMbulkoperation> KnowledgearticleBulkOperations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_CampaignResponses")]
        [NotMapped] public IList<MicrosoftDynamicsCRMcampaignresponse> KnowledgearticleCampaignResponses { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_IncidentResolutions")]
        [NotMapped] public IList<MicrosoftDynamicsCRMincidentresolution> KnowledgearticleIncidentResolutions { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_ServiceAppointments")]
        [NotMapped] public IList<MicrosoftDynamicsCRMserviceappointment> KnowledgeArticleServiceAppointments { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "incident_knowledgearticles")]
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticleincident> IncidentKnowledgearticles { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_OpportunityCloses")]
        [NotMapped] public IList<MicrosoftDynamicsCRMopportunityclose> KnowledgearticleOpportunityCloses { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_OrderCloses")]
        [NotMapped] public IList<MicrosoftDynamicsCRMorderclose> KnowledgearticleOrderCloses { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_QuoteCloses")]
        [NotMapped] public IList<MicrosoftDynamicsCRMquoteclose> KnowledgearticleQuoteCloses { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMconnection> KnowledgearticleConnections1 { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_connections2")]
        [NotMapped] public IList<MicrosoftDynamicsCRMconnection> KnowledgearticleConnections2 { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_DuplicateMatchingRecord")]
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> KnowledgearticleDuplicateMatchingRecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_DuplicateBaseRecord")]
        [NotMapped] public IList<MicrosoftDynamicsCRMduplicaterecord> KnowledgearticleDuplicateBaseRecord { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_SharePointDocumentLocations")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsharepointdocumentlocation> KnowledgearticleSharePointDocumentLocations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_QueueItems")]
        [NotMapped] public IList<MicrosoftDynamicsCRMqueueitem> KnowledgearticleQueueItems { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_Annotations")]
        [NotMapped] public IList<MicrosoftDynamicsCRMannotation> KnowledgearticleAnnotations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_Teams")]
        [NotMapped] public IList<MicrosoftDynamicsCRMteam> KnowledgearticleTeams { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_AsyncOperations")]
        [NotMapped] public IList<MicrosoftDynamicsCRMasyncoperation> KnowledgearticleAsyncOperations { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_ProcessSession")]
        [NotMapped] public IList<MicrosoftDynamicsCRMprocesssession> KnowledgearticleProcessSession { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_BulkDeleteFailures")]
        [NotMapped] public IList<MicrosoftDynamicsCRMbulkdeletefailure> KnowledgearticleBulkDeleteFailures { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_PrincipalObjectAttributeAccess")]
        [NotMapped] public IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> KnowledgearticlePrincipalObjectAttributeAccess { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMexpiredprocess> KnowledgearticleExpiredprocess { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_translationprocess")]
        [NotMapped] public IList<MicrosoftDynamicsCRMtranslationprocess> KnowledgearticleTranslationprocess { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_SyncErrors")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsyncerror> KnowledgeArticleSyncErrors { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMrecurringappointmentmaster> KnowledgeArticleRecurringAppointmentMasters { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_Letters")]
        [NotMapped] public IList<MicrosoftDynamicsCRMletter> KnowledgeArticleLetters { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_SocialActivities")]
        [NotMapped] public IList<MicrosoftDynamicsCRMsocialactivity> KnowledgeArticleSocialActivities { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_ActivityPointers")]
        [NotMapped] public IList<MicrosoftDynamicsCRMactivitypointer> KnowledgeArticleActivityPointers { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_newprocess")]
        [NotMapped] public IList<MicrosoftDynamicsCRMnewprocess> KnowledgearticleNewprocess { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_Faxes")]
        [NotMapped] public IList<MicrosoftDynamicsCRMfax> KnowledgeArticleFaxes { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticle> KnowledgearticlePreviousarticleContentid { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticle> KnowledgearticleRootarticleId { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_views")]
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticleviews> KnowledgearticleViews { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMphonecall> KnowledgeArticlePhonecalls { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMknowledgearticle> KnowledgearticleParentarticleContentid { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_category")]
        [NotMapped] public IList<MicrosoftDynamicsCRMcategory> KnowledgearticleCategory { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_activity_parties")]
        [NotMapped] public IList<MicrosoftDynamicsCRMactivityparty> KnowledgearticleActivityParties { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_Emails")]
        [NotMapped] public IList<MicrosoftDynamicsCRMemail> KnowledgeArticleEmails { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_Tasks")]
        [NotMapped] public IList<MicrosoftDynamicsCRMtask> KnowledgeArticleTasks { get; set; }
        ...
        [NotMapped] public IList<MicrosoftDynamicsCRMappointment> KnowledgeArticleAppointments { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_PostRegardings")]
        [NotMapped] public IList<MicrosoftDynamicsCRMpostregarding> KnowledgearticlePostRegardings { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "knowledgearticle_PostFollows")]
        [NotMapped] public IList<MicrosoftDynamicsCRMpostfollow> KnowledgearticlePostFollows { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "KnowledgeArticle_Feedback")]
        [NotMapped] public IList<MicrosoftDynamicsCRMfeedback> KnowledgeArticleFeedback { get; set; }
