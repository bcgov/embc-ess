    ...
    {        
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Community>()
                .HasOptional(c => c.PrimaryContact)
                .WithMany();
            ...
            modelBuilder.Entity<People>()
                .HasOptional(c => c.Organisation)
                .WithMany();

            modelBuilder.Entity<People>()
                .HasOptional(c => c.Community)
                .WithMany();
            
            modelBuilder.Entity<Facility>()
                .HasOptional(c => c.EMBCRepresentative)
                .WithMany();
            ...
            modelBuilder.Entity<Registration>()
                .HasOptional(c => c.Evacuee)
                .WithMany();

            modelBuilder.Entity<Registration>()
                .HasOptional(c => c.Volunteer)
                .WithMany();
