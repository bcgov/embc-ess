...
{
    public partial class Duplicate_Self_Registrations_Fix : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
            ALTER VIEW [dbo].[viewEvacuee]
            AS
            ...
            LEFT OUTER JOIN
            EvacueeRegistrationAddresses era ON e.RegistrationId = era.RegistrationId and era.AddressTypeCode = 'Primary'
            LEFT OUTER JOIN
            Countries countries ON era.CountryCode = countries.CountryCode
            ");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            // We don't want to undo this fix
        }
    }
}
