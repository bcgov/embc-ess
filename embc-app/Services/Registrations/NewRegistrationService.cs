...
";
            ...
            if (registration.IncidentTask == null)
            {
                body += $@"
<br/><br/>
- If you are under order and require any emergency support services, proceed to your designated Reception Centre. A list of open Reception Centres can be found at {emergencyInfoBCLink}.<br/>
