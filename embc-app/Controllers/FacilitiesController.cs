...
namespace Gov.Jag.Embc.Public.Controllers
{
    ...
    public class FacilitiesController : Controller
    {
        ...
        public FacilitiesController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, ILoggerFactory loggerFactory, IHostingEnvironment env)
        {
            Configuration = configuration;
            _httpContextAccessor = httpContextAccessor;
            _logger = loggerFactory.CreateLogger(typeof(FacilitiesController));
            this._env = env;
        }
