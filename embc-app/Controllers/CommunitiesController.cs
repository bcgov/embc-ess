...
namespace Gov.Jag.Embc.Public.Controllers
{
    ...
    public class CommunitiesController : Controller
    {
        ...
        public CommunitiesController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, ILoggerFactory loggerFactory, IHostingEnvironment env, IDataInterface dataInterface)
        {
