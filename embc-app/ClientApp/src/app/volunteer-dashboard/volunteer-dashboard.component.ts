...
import { EvacueeSearchResults } from '../shared/utils';
...
export class VolunteerDashboardComponent implements OnInit {
  ...
  doSearch(query?: string) {
    // TODO: Make use of the query input to filter the result set...
    this.resultsAndPagination$ = this.registrationService.getRegistrations();
    this.searchResults$ = this.resultsAndPagination$.pipe(
      map(x => ({ results: x.data, query } as EvacueeSearchResults)),
  ...
  //       this.searchResults = registrations.data;
