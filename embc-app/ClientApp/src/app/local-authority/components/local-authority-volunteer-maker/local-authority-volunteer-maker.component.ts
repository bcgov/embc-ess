...
@Component({
  selector: 'app-local-authority-volunteer-maker',
  templateUrl: './local-authority-volunteer-maker.component.html',
  styleUrls: ['./local-authority-volunteer-maker.component.scss']
})
export class LocalAuthorityVolunteerMakerComponent implements OnInit {
